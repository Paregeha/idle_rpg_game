...
/// the server owns this state.
 Map<String, int> get skills;/// Every item the player owns, by its instance id.
...
/// Create a copy of PlayerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? lastTickAtMs = null,Object? rngSeed = null,Object? version = null,Object? carryOverMs = null,Object? resources = null,Object? generators = null,Object? upgrades = null,Object? earnedThisRun = null,Object? chapter = null,Object? stage = null,Object? wave = null,Object? skills = null,Object? inventory = null,Object? equipped = null,Object? rngState = null,Object? itemsCreated = null,Object? pityCounter = null,Object? prestige = null,}) {
...
as Map<String, int>,inventory: null == inventory ? _self.inventory : inventory // ignore: cast_nullable_to_non_nullable
...
class _PlayerState extends PlayerState {
  const _PlayerState({required this.lastTickAtMs, required this.rngSeed, this.version = stateSchemaVersion, this.carryOverMs = 0, @BigNumConverter() final  Map<String, BigNum> resources = const <String, BigNum>{}, final  Map<String, GeneratorState> generators = const <String, GeneratorState>{}, final  Map<String, int> upgrades = const <String, int>{}, @BigNumConverter() final  Map<String, BigNum> earnedThisRun = const <String, BigNum>{}, this.chapter = 1, this.stage = 1, this.wave = 0, final  Map<String, int> skills = const <String, int>{}, final  Map<String, OwnedItem> inventory = const <String, OwnedItem>{}, final  Map<String, String> equipped = const <String, String>{}, final  List<int> rngState = const <int>[], this.itemsCreated = 0, this.pityCounter = 0, this.prestige = const PrestigeState()}): _resources = resources,_generators = generators,_upgrades = upgrades,_earnedThisRun = earnedThisRun,_skills = skills,_inventory = inventory,_equipped = equipped,_rngState = rngState,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PlayerState&&(identical(other.lastTickAtMs, lastTickAtMs) || other.lastTickAtMs == lastTickAtMs)&&(identical(other.rngSeed, rngSeed) || other.rngSeed == rngSeed)&&(identical(other.version, version) || other.version == version)&&(identical(other.carryOverMs, carryOverMs) || other.carryOverMs == carryOverMs)&&const DeepCollectionEquality().equals(other._resources, _resources)&&const DeepCollectionEquality().equals(other._generators, _generators)&&const DeepCollectionEquality().equals(other._upgrades, _upgrades)&&const DeepCollectionEquality().equals(other._earnedThisRun, _earnedThisRun)&&(identical(other.chapter, chapter) || other.chapter == chapter)&&(identical(other.stage, stage) || other.stage == stage)&&(identical(other.wave, wave) || other.wave == wave)&&const DeepCollectionEquality().equals(other._skills, _skills)&&const DeepCollectionEquality().equals(other._inventory, _inventory)&&const DeepCollectionEquality().equals(other._equipped, _equipped)&&const DeepCollectionEquality().equals(other._rngState, _rngState)&&(identical(other.itemsCreated, itemsCreated) || other.itemsCreated == itemsCreated)&&(identical(other.pityCounter, pityCounter) || other.pityCounter == pityCounter)&&(identical(other.prestige, prestige) || other.prestige == prestige));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,lastTickAtMs,rngSeed,version,carryOverMs,const DeepCollectionEquality().hash(_resources),const DeepCollectionEquality().hash(_generators),const DeepCollectionEquality().hash(_upgrades),const DeepCollectionEquality().hash(_earnedThisRun),chapter,stage,wave,const DeepCollectionEquality().hash(_skills),const DeepCollectionEquality().hash(_inventory),const DeepCollectionEquality().hash(_equipped),const DeepCollectionEquality().hash(_rngState),itemsCreated,pityCounter,prestige);
...
/// Create a copy of PlayerState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? lastTickAtMs = null,Object? rngSeed = null,Object? version = null,Object? carryOverMs = null,Object? resources = null,Object? generators = null,Object? upgrades = null,Object? earnedThisRun = null,Object? chapter = null,Object? stage = null,Object? wave = null,Object? skills = null,Object? inventory = null,Object? equipped = null,Object? rngState = null,Object? itemsCreated = null,Object? pityCounter = null,Object? prestige = null,}) {
...
as Map<String, int>,inventory: null == inventory ? _self._inventory : inventory // ignore: cast_nullable_to_non_nullable
