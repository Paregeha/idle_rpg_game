...
@BigNumConverter() Map<String, BigNum> get earnedThisRun;/// Chapter, stage and wave: where the player is in the world.
 ...
 int get wave;/// Skill levels, by skill id. A skill absent here is one the player has
/// never seen.
 Map<String, int> get skills;/// Unspent duplicate copies, by skill id.
///
...
/// map rather than as entries in the inventory.
 Map<String, int> get skillCopies;/// Skill packs opened since the last guaranteed pull.
 int get skillPity;/// Rarity rank at or below which dropped gear is broken down on sight.
///
/// `-1` is off, and is the default: a game that destroys gear nobody asked
/// it to destroy is a game the player stops trusting.
 int get autoSalvageRank;/// Whether skills fire by themselves.
///
...
/// for a player who wants to see what their gear alone is worth.
 bool get autoCast;/// The hero's own level, earned by killing things.
...
/// Create a copy of PlayerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? lastTickAtMs = null,Object? rngSeed = null,Object? version = null,Object? carryOverMs = null,Object? resources = null,Object? generators = null,Object? upgrades = null,Object? earnedThisRun = null,Object? chapter = null,Object? stage = null,Object? wave = null,Object? skills = null,Object? skillCopies = null,Object? skillPity = null,Object? autoSalvageRank = null,Object? autoCast = null,Object? heroLevel = null,Object? heroExperience = null,Object? inventory = null,Object? equipped = null,Object? rngState = null,Object? itemsCreated = null,Object? pityCounter = null,Object? prestige = null,}) {
...
as Map<String, int>,skillCopies: null == skillCopies ? _self.skillCopies : skillCopies // ignore: cast_nullable_to_non_nullable
as Map<String, int>,skillPity: null == skillPity ? _self.skillPity : skillPity // ignore: cast_nullable_to_non_nullable
as int,autoSalvageRank: null == autoSalvageRank ? _self.autoSalvageRank : autoSalvageRank // ignore: cast_nullable_to_non_nullable
as int,autoCast: null == autoCast ? _self.autoCast : autoCast // ignore: cast_nullable_to_non_nullable
as bool,heroLevel: null == heroLevel ? _self.heroLevel : heroLevel // ignore: cast_nullable_to_non_nullable
...
class _PlayerState extends PlayerState {
  const _PlayerState({required this.lastTickAtMs, required this.rngSeed, this.version = stateSchemaVersion, this.carryOverMs = 0, @BigNumConverter() final  Map<String, BigNum> resources = const <String, BigNum>{}, final  Map<String, GeneratorState> generators = const <String, GeneratorState>{}, final  Map<String, int> upgrades = const <String, int>{}, @BigNumConverter() final  Map<String, BigNum> earnedThisRun = const <String, BigNum>{}, this.chapter = 1, this.stage = 1, this.wave = 0, final  Map<String, int> skills = const <String, int>{}, final  Map<String, int> skillCopies = const <String, int>{}, this.skillPity = 0, this.autoSalvageRank = -1, this.autoCast = true, this.heroLevel = 0, @BigNumConverter() this.heroExperience = BigNum.zero, final  Map<String, OwnedItem> inventory = const <String, OwnedItem>{}, final  Map<String, String> equipped = const <String, String>{}, final  List<int> rngState = const <int>[], this.itemsCreated = 0, this.pityCounter = 0, this.prestige = const PrestigeState()}): _resources = resources,_generators = generators,_upgrades = upgrades,_earnedThisRun = earnedThisRun,_skills = skills,_skillCopies = skillCopies,_inventory = inventory,_equipped = equipped,_rngState = rngState,super._();
...
/// skill is a number, not another object — so duplicates live in their own
/// map rather than as entries in the inventory.
 final  Map<String, int> _skillCopies;
/// Unspent duplicate copies, by skill id.
///
/// Skills are not instanced the way items are — a second copy of the same
/// skill is a number, not another object — so duplicates live in their own
/// map rather than as entries in the inventory.
@override@JsonKey() Map<String, int> get skillCopies {
  if (_skillCopies is EqualUnmodifiableMapView) return _skillCopies;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_skillCopies);
}

/// Skill packs opened since the last guaranteed pull.
@override@JsonKey() final  int skillPity;
/// Rarity rank at or below which dropped gear is broken down on sight.
///
/// `-1` is off, and is the default: a game that destroys gear nobody asked
/// it to destroy is a game the player stops trusting.
@override@JsonKey() final  int autoSalvageRank;
/// Whether skills fire by themselves.
///
/// On by default: an idle game whose skills need a tap is not idle. Off is
/// for a player who wants to see what their gear alone is worth.
@override@JsonKey() final  bool autoCast;
...
/// Create a copy of PlayerState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? lastTickAtMs = null,Object? rngSeed = null,Object? version = null,Object? carryOverMs = null,Object? resources = null,Object? generators = null,Object? upgrades = null,Object? earnedThisRun = null,Object? chapter = null,Object? stage = null,Object? wave = null,Object? skills = null,Object? skillCopies = null,Object? skillPity = null,Object? autoSalvageRank = null,Object? autoCast = null,Object? heroLevel = null,Object? heroExperience = null,Object? inventory = null,Object? equipped = null,Object? rngState = null,Object? itemsCreated = null,Object? pityCounter = null,Object? prestige = null,}) {
...
as Map<String, int>,skillCopies: null == skillCopies ? _self._skillCopies : skillCopies // ignore: cast_nullable_to_non_nullable
as Map<String, int>,skillPity: null == skillPity ? _self.skillPity : skillPity // ignore: cast_nullable_to_non_nullable
as int,autoSalvageRank: null == autoSalvageRank ? _self.autoSalvageRank : autoSalvageRank // ignore: cast_nullable_to_non_nullable
as int,autoCast: null == autoCast ? _self.autoCast : autoCast // ignore: cast_nullable_to_non_nullable
as bool,heroLevel: null == heroLevel ? _self.heroLevel : heroLevel // ignore: cast_nullable_to_non_nullable
