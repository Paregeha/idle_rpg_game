...
/// Schema version of this config.
 int get version; Map<String, GeneratorConfig> get generators; Map<String, MonsterConfig> get monsters; PrestigeConfig get prestige; HeroConfig get hero;/// Equipment slots, in display order. Data rather than an enum: adding a
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BalanceConfig&&(identical(other.version, version) || other.version == version)&&const DeepCollectionEquality().equals(other.generators, generators)&&const DeepCollectionEquality().equals(other.monsters, monsters)&&(identical(other.prestige, prestige) || other.prestige == prestige)&&(identical(other.hero, hero) || other.hero == hero)&&const DeepCollectionEquality().equals(other.slots, slots)&&const DeepCollectionEquality().equals(other.rarities, rarities)&&const DeepCollectionEquality().equals(other.items, items)&&(identical(other.start, start) || other.start == start)&&(identical(other.offlineCapMs, offlineCapMs) || other.offlineCapMs == offlineCapMs));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,version,const DeepCollectionEquality().hash(generators),const DeepCollectionEquality().hash(monsters),prestige,hero,const DeepCollectionEquality().hash(slots),const DeepCollectionEquality().hash(rarities),const DeepCollectionEquality().hash(items),start,offlineCapMs);

@override
String toString() {
  return 'BalanceConfig(version: $version, generators: $generators, monsters: $monsters, prestige: $prestige, hero: $hero, slots: $slots, rarities: $rarities, items: $items, start: $start, offlineCapMs: $offlineCapMs)';
}
...
@useResult
$Res call({
 int version, Map<String, GeneratorConfig> generators, Map<String, MonsterConfig> monsters, PrestigeConfig prestige, HeroConfig hero, List<String> slots, Map<String, RarityConfig> rarities, Map<String, ItemConfig> items, StartConfig start, int offlineCapMs
});


$PrestigeConfigCopyWith<$Res> get prestige;$HeroConfigCopyWith<$Res> get hero;$StartConfigCopyWith<$Res> get start;
...
/// Create a copy of BalanceConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? version = null,Object? generators = null,Object? monsters = null,Object? prestige = null,Object? hero = null,Object? slots = null,Object? rarities = null,Object? items = null,Object? start = null,Object? offlineCapMs = null,}) {
...
as HeroConfig,slots: null == slots ? _self.slots : slots // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int version,  Map<String, GeneratorConfig> generators,  Map<String, MonsterConfig> monsters,  PrestigeConfig prestige,  HeroConfig hero,  List<String> slots,  Map<String, RarityConfig> rarities,  Map<String, ItemConfig> items,  StartConfig start,  int offlineCapMs)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BalanceConfig() when $default != null:
return $default(_that.version,_that.generators,_that.monsters,_that.prestige,_that.hero,_that.slots,_that.rarities,_that.items,_that.start,_that.offlineCapMs);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int version,  Map<String, GeneratorConfig> generators,  Map<String, MonsterConfig> monsters,  PrestigeConfig prestige,  HeroConfig hero,  List<String> slots,  Map<String, RarityConfig> rarities,  Map<String, ItemConfig> items,  StartConfig start,  int offlineCapMs)  $default,) {final _that = this;
switch (_that) {
case _BalanceConfig():
return $default(_that.version,_that.generators,_that.monsters,_that.prestige,_that.hero,_that.slots,_that.rarities,_that.items,_that.start,_that.offlineCapMs);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int version,  Map<String, GeneratorConfig> generators,  Map<String, MonsterConfig> monsters,  PrestigeConfig prestige,  HeroConfig hero,  List<String> slots,  Map<String, RarityConfig> rarities,  Map<String, ItemConfig> items,  StartConfig start,  int offlineCapMs)?  $default,) {final _that = this;
switch (_that) {
case _BalanceConfig() when $default != null:
return $default(_that.version,_that.generators,_that.monsters,_that.prestige,_that.hero,_that.slots,_that.rarities,_that.items,_that.start,_that.offlineCapMs);case _:
  return null;
...
class _BalanceConfig extends BalanceConfig {
  const _BalanceConfig({this.version = supportedBalanceVersion, final  Map<String, GeneratorConfig> generators = const <String, GeneratorConfig>{}, final  Map<String, MonsterConfig> monsters = const <String, MonsterConfig>{}, this.prestige = const PrestigeConfig(), this.hero = const HeroConfig(), final  List<String> slots = const <String>[], final  Map<String, RarityConfig> rarities = const <String, RarityConfig>{}, final  Map<String, ItemConfig> items = const <String, ItemConfig>{}, this.start = const StartConfig(), this.offlineCapMs = _eightHoursMs}): _generators = generators,_monsters = monsters,_slots = slots,_rarities = rarities,_items = items,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BalanceConfig&&(identical(other.version, version) || other.version == version)&&const DeepCollectionEquality().equals(other._generators, _generators)&&const DeepCollectionEquality().equals(other._monsters, _monsters)&&(identical(other.prestige, prestige) || other.prestige == prestige)&&(identical(other.hero, hero) || other.hero == hero)&&const DeepCollectionEquality().equals(other._slots, _slots)&&const DeepCollectionEquality().equals(other._rarities, _rarities)&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.start, start) || other.start == start)&&(identical(other.offlineCapMs, offlineCapMs) || other.offlineCapMs == offlineCapMs));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,version,const DeepCollectionEquality().hash(_generators),const DeepCollectionEquality().hash(_monsters),prestige,hero,const DeepCollectionEquality().hash(_slots),const DeepCollectionEquality().hash(_rarities),const DeepCollectionEquality().hash(_items),start,offlineCapMs);
...
@override $PrestigeConfigCopyWith<$Res> get prestige;@override $HeroConfigCopyWith<$Res> get hero;@override $StartConfigCopyWith<$Res> get start;
...
/// Create a copy of BalanceConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? version = null,Object? generators = null,Object? monsters = null,Object? prestige = null,Object? hero = null,Object? slots = null,Object? rarities = null,Object? items = null,Object? start = null,Object? offlineCapMs = null,}) {
...
as Map<String, MonsterConfig>,prestige: null == prestige ? _self.prestige : prestige // ignore: cast_nullable_to_non_nullable
as PrestigeConfig,hero: null == hero ? _self.hero : hero // ignore: cast_nullable_to_non_nullable
as HeroConfig,slots: null == slots ? _self._slots : slots // ignore: cast_nullable_to_non_nullable
