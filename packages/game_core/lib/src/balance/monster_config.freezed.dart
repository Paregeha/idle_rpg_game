...
@BigNumConverter() BigNum get baseAttack;/// Attack is multiplied by this per level.
 ...
 double get dodgeChance;/// Probability in `0..1` that a kill drops an item.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,baseHp,hpGrowth,rewardBase,rewardGrowth,baseAttack,attackGrowth,attacksPerSecond,mitigation,dodgeChance,dropChance);

@override
String toString() {
  return 'MonsterConfig(baseHp: $baseHp, hpGrowth: $hpGrowth, rewardBase: $rewardBase, rewardGrowth: $rewardGrowth, baseAttack: $baseAttack, attackGrowth: $attackGrowth, attacksPerSecond: $attacksPerSecond, mitigation: $mitigation, dodgeChance: $dodgeChance, dropChance: $dropChance)';
}
...
@useResult
$Res call({
@BigNumConverter() BigNum baseHp, double hpGrowth,@BigNumConverter() BigNum rewardBase, double rewardGrowth,@BigNumConverter() BigNum baseAttack, double attackGrowth, double attacksPerSecond, double mitigation, double dodgeChance, double dropChance
});
...
/// Create a copy of MonsterConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? baseHp = null,Object? hpGrowth = null,Object? rewardBase = null,Object? rewardGrowth = null,Object? baseAttack = null,Object? attackGrowth = null,Object? attacksPerSecond = null,Object? mitigation = null,Object? dodgeChance = null,Object? dropChance = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@BigNumConverter()  BigNum baseHp,  double hpGrowth, @BigNumConverter()  BigNum rewardBase,  double rewardGrowth, @BigNumConverter()  BigNum baseAttack,  double attackGrowth,  double attacksPerSecond,  double mitigation,  double dodgeChance,  double dropChance)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MonsterConfig() when $default != null:
return $default(_that.baseHp,_that.hpGrowth,_that.rewardBase,_that.rewardGrowth,_that.baseAttack,_that.attackGrowth,_that.attacksPerSecond,_that.mitigation,_that.dodgeChance,_that.dropChance);case _:
  return orElse();
...
/// Create a copy of MonsterConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? baseHp = null,Object? hpGrowth = null,Object? rewardBase = null,Object? rewardGrowth = null,Object? baseAttack = null,Object? attackGrowth = null,Object? attacksPerSecond = null,Object? mitigation = null,Object? dodgeChance = null,Object? dropChance = null,}) {
